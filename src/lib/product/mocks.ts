...
export const products = [
  {
    ...
    inStock: true,
    images: [
      "/images/pioneer-ts-a1600c-1.jpg",
      "/images/pioneer-ts-a1600c-2.jpg"
    ],
    features: {
      мощность: "80 Вт",
      импеданс: "4 Ом",
  ...
  },
  {
    ...
    inStock: true,
    images: [
      "/images/alpine-s-s65-1.jpg",
      "/images/alpine-s-s65-2.jpg"
    ],
    features: {
      мощность: "100 Вт",
      импеданс: "4 Ом",
  ...
  },
  {
    ...
    inStock: true,
    images: [
      "/images/kenwood-dmx8020dabs-1.jpg",
      "/images/kenwood-dmx8020dabs-2.jpg"
    ],
    features: {
      экран: "6.8\" сенсорный",
  ...
  },
  {
    ...
    inStock: true,
    images: [
      "/images/hertz-hcp-4d-1.jpg",
      "/images/hertz-hcp-4d-2.jpg"
    ],
    features: {
      мощность: "4x100 Вт",
      классУсиления: "D",
